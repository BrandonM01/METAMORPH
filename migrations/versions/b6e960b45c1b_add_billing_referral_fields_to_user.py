...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        # batch_op.drop_column('drive_folder_id')  # <-- Removed because it doesn't exist
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('user', schema=None) as batch_op:
        # batch_op.add_column(sa.Column('drive_folder_id', sa.VARCHAR(length=300), nullable=True))  # Optional, see note above
